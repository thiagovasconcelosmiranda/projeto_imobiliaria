            ...
            <div class="footer-i-top">
                 <div class="footer-col-top">
                  ...
                  <div class="text-i">
                    ...
                    <a href="<?=$base;?>/nao-encontrei"><p>Preencha o formulário referente ao imovel 
                      desejado e seja notificado. </p></a>
                  </div>
                 </div>
                 <div class="footer-col-top">
                  <div class="i-circle">
                  ...
                  <div class="text-i">
                    ...
                    <a href="<?=$base;?>/sobre"><p>Saiba mais sobre nossa visão e missão. </p></a>
                  </div>
                 </div>
            </div> 
