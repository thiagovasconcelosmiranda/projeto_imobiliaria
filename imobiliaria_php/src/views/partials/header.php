...
<head>
    ...
    <link rel="stylesheet" href="<?= $base; ?>/assets/css/styless.css">
                    ...
                    <form method="POST" action="<?= $base; ?>/busca-imovel">
                        <div class="button-i">
                            <div class="respansive-button">
                                ...
                                <button onclick="butonClick('Impreendimento')" class="button"
                                    type="button">Impreendimento</button>
                                <button onclick="butonClick('Investimento')" class="button"
                                    type="button">Investimento</button>
                            </div>
                        </div>
                        <div class="group-select-row">
                            ...
                            <div class="group-option-row">
                                <div class="group-option-col">
                                    ...
                                    <div class="group-check">
                                        <input type="checkbox" value="comercial/Salão Varejo" name="tipo/salao_varejo"
                                            onclick="buttonRadio(4)">
                                ...
                                <div class="group-option-col">
                                    <p>Residêncial</p>
                                    <div class="group-check">
                                        <input type="checkbox" value="residencial/Apartamento" name="tipo/apartamento"
                                            onclick="buttonRadio(6)">
                            ...
                            <div class="group-option-row-3">
                                ...
                                <div class="group-option-col">
                                    <div class="group-check">
                                        <input type="checkbox" value="Condomínio Village do Bosque" name="condominio"
                                            onclick="buttonRadio(41)">
