          ...
          <?php foreach($imoveis as $imovel):
            ...
            ?>
                <div class="card">
                   ...
                   <div class="card-img">
                     <div class="inf-i" style="display: <?php echo ($imovel['condicao'] != 0 ? 'flex': 'none'); ?>"><?=$imovel['condicao'];?></div>
                     <div class="inf-i green" style="left: 40%"><?=$c[0];?></div>
                     <div class="inf-i blue" style="left: 70%; display: <?php echo (isset($c[1]) ? 'flex': 'none');?>"><?=$c[1];?></div>
